...
![显示按键](../../images/user_guide/remote/screen/web-screen-button.webp)
...
![网页较高画面](../../images/user_guide/remote/screen/web-screen-long.webp)

![网页较宽画面](../../images/user_guide/remote/screen/web-screen-fat.webp)

- 当HDMI没有接入时，远程画面会显示一个提示信息，提示信息为“远程画面未连接”，如下图所示：

![HDMI没有接入画面提示](../../images/user_guide/remote/screen/web-screen-hdmi-out.webp)

- 当远程主机进入休眠状态或者hdmi连接信号丢失时，远程画面会显示一个提示信息，提示信息为“主机休眠中或者主机信号丢失”，如下图所示：

![信号丢失画面提示](../../images/user_guide/remote/screen/web-screen-suspend.webp)
...
![EDID](../../images/user_guide/remote/screen/web-screen-edid.webp)

> 用户可以在设置中添加自己的edid配置，详情请参考[edid配置](../../user_guide/advance/edid.md)，配置之后下拉选择会多出"custom"选项

**flexkvm_default**为默认的edid配置，拥有非常丰富的分辨率组合，如下表格：
...
画质分为四档，分别为"低"、"中"、"高"和"极高"，默认为"高"

- **低**表示画质最低，码率最小，画面质量最差。
- **中**表示画质中等，码率中等，画面质量中等。
- **高**表示画质高，码率大，画面质量好。
- **极高**表示画质最高，码率最大，画面质量最好。

> 提示：用户可以根据自己的网络环境选择合适的画质，画质越高，画面质量越好，画质越低，画面质量越差。
...
![全屏](../../images/user_guide/remote/screen/web-screen-full.webp)

全屏按键位于菜单栏的最右侧，点击全屏按钮，会全屏显示远程画面，如下图所示：

![全屏](../../images/user_guide/remote/screen/web-screen-fullscreen.webp)
