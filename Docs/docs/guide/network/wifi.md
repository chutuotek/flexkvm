...
长按**按键 B** 约 3~5 秒，在 WiFi 和[AP 热点](./ap.md)之间快速切换：
...
**OWE 网络**：点卡片展开 → 点连接。无需密码（机会加密，流量已加密）。
...
|------|------|
| 网络名称 (SSID) | WiFi 名称 |
| 加密类型 | 开放 / WPA / WPA2 / WPA3 / WPA-WPA2 / WPA2-WPA3 / OWE |
| 密码 | 口令型加密网络需填写；开放与 OWE 留空 |

> **OWE（Enhanced Open）**：公共或访客网络的机会加密——无需密码，客户端与热点自动协商密钥。
