...
![升级界面](../../images/guide/update/update/update-ui.png)
...
![上传进度条](../../images/guide/update/update/offline-upload.png)
...
![升级包验证框](../../images/guide/update/update/offline-check.png)

上面有镜像文件的sha256sum值，需要用户进行验证，如果验证该固件没问题后，可以点击升级，然后会弹出一个用户验证框，如下图所示：

![用户验证框](../../images/guide/update/update/offline-update-verify.png)
...
![升级进度](../../images/guide/update/update/offline-update.png)
