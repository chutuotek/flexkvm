...
![2FA设置](./account/images/2fa-gen.webp)
...
SSH 登录不需要 2FA 验证码，仅需账号密码。如果需要更严格的 SSH 安全控制，可以关闭 SSH 服务，详见 [SSH](./ssh.md)。
...
SSH 详细配置和可用命令见 [SSH 远程访问](./ssh.md)。
...
- 需要查看或导出日志？→ [日常运维](../scenarios/daily-ops.md)
- 如何在外网安全访问？→ [外网远程访问](../scenarios/remote-access.md)
