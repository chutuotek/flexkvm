...
Scan the QR code to follow the ChuoTuoTEK WeChat Official Account (楚拓电子公众号). Then go to the menu: "User Community" → "WeChat Group" to get the latest group QR code.
